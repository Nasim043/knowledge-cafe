...
const SingleBlog = (props) => {
  ...
  return (
    <div className="card w-full md:w-11/12 bg-base-100 shadow-xl mb-8 rounded-md">
      ...
      <p className='font-medium text-lg px-1 my-4 text-title-blue cursor-pointer underline decoration-title-blue' onClick={()=>{handleSpentTime(read_time)}}>Mark as read</p>
    </div>
  );
};
